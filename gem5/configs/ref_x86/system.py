...
class MySystem(LinuxX86System):
    ...
    def __init__(self, opts):
        ...
        self.createCPU()
	self.cpu.createThreads()	# Tina Fix
    ...
    def createCPU(self):
        ...
        #self.cpu = AtomicSimpleCPU()	# Tina Fix
        self.cpu = DerivO3CPU()	# Tina Fix
        #self.mem_mode = 'atomic'	# Tina Fix
        self.mem_mode = 'timing'	# Tina Fix
    ...
    def createMemoryControllers(self):
        ...
        self.mem_cntrl = DDR3_1600_8x8(range = self.mem_ranges[0],	# Tina Fix
